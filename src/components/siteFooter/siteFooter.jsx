...
export class SiteFooter extends React.Component {
    ...
    render() {
        ...
        if (this.state.contentData && this.state.contentData.elements) {
            ...
            custServiceLabel = this.state.contentData.elements.labelForCustomerService.value;
            custServiceNumber = this.state.contentData.elements.customerServiceContactNumber.value;
                    ...
                    <div className="grid-container">
                        <div className="grid-x grid-padding-x">
                                ...
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com">
                                            <FbLogo />
                                            <span className="show-for-medium">Facebook</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://twitter.com">
                                            <TwitterLogo />
                                            <span className="show-for-medium">Twitter</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com">
                                            <InstagramLogo />
                                            <span className="show-for-medium">Instagram</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="medium-3 cell contact-us">
                                <h5>Contact us</h5>
                                <ul>
                                    <li><span>{salesLabel}</span> <a href={`tel:${salesNumber}`}>
                                    {salesNumber} </a></li>

                                    <li><span>{custServiceLabel}</span> <a href={`tel:${custServiceNumber}`}>
                                    {custServiceNumber}</a></li>

                                    <li><span>email</span> <a href={`mailto:${emailAddress}`}>
                                    {emailAddress}</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="grid-x legal">
                            <div className="copyright">&copy; <span>{copyrightYear}</span> {copyrightText}</div>
                        </div>
                    </div>
                </div>
            </footer>
