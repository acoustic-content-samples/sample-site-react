        ...
        return (
            <div className="searchWrapper">
                <form className="search-form" id="search-form" name="search-form"> 
                    <input type="search" value={this.state.query} name="searchTerm" 
                    className={checkQLength() ? 'active-input' : ''} onChange={this.handleChange}>
                    </input> 
                        ...
                        <div onClick={clearSearch} className={checkQLength() ? 'show-clear-button' : 'search-input-clear'}>
                            <SearchInputClear/>  
                        </div> 
                </form>         
            </div> 
