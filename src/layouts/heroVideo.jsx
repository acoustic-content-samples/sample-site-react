...
export class HeroVideo extends React.Component{
    ...
    videoElementId () {return 'hero-video-' + this.props.renderingContext.id}
    ...
    render(){
        ...
        if(this.props.renderingContext) {
			...
			if (this.props.renderingContext) {
				videoUrl = getVideoUrl(this.props.renderingContext.elements.video);
				mediaType = this.props.renderingContext.elements.video.asset ? this.props.renderingContext.elements.video.asset.mediaType : '';
			}

			return (
			    <div data-renderingcontext-id={this.props.renderingContext.id}>
                    <div data-wch-inline-edit="elements.video" id={this.props.renderingContext.id} className="wch-hero-video responsive-embed widescreen">
                        <video
